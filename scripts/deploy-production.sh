...
PROTECTED_DATA_TABLES="${PROTECTED_DATA_TABLES:-users products teams projects project_revisions project_areas project_lines project_tenders document_packs document_pack_items resource_files team_user activity_logs salesforce_pdf_uploads}"
