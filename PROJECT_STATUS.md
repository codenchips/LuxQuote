...
- PHP's `X-Powered-By` version banner is disabled. The current hardened build passes **395 tests / 2,324 assertions**, asset compilation, application/PDF health checks, workflow linting, shell syntax checks, and dependency audits.
